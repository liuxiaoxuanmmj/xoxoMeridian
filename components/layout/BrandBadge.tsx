 ...
 */
export function BrandBadge({ href = "/home" }: { href?: string }) {
  const badge = (
    <div className="flex items-center gap-2.5">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[8px] bg-[#3a5b22] text-sm font-bold text-white">
        X
      </div>
      <div>
